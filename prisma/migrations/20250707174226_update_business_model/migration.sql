...
-- AddForeignKey
ALTER TABLE "MenuSection" ADD CONSTRAINT "MenuSection_businessId_fkey" FOREIGN KEY ("businessId") REFERENCES "Business"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_BusinessAdmins" ADD CONSTRAINT "_BusinessAdmins_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
